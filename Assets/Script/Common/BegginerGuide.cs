    ...
    public void Commentary() {
        ...
        switch (guideType) {
            ...
            case GUIDE_TYPE.禁止事項:
                ...
                switch (num) {
                    case 1:
                        commentaryText.text = "基本的に、わざと敗北へ導く行為全て禁止とします。\r\n生存中に回線を切る、会話に参加しない行為（突然死）\r\n他の役職を不正方法で把握する行為（ゴースティング）\r\n意味なく別役職のカミングアウト（利敵行為）\r\n暴言等、著しく不快な言動（暴言）\r\n上級者が初心者のふりをする行為（初心者詐欺）\r\n占い結果などゲームシステムを利用した発言\r\nバグ技の利用\r\n日本語以外での会話\r\nその他ゲームとして成立しない言動";
                        break;
                    case 2:
                        commentaryText.text = "初めてプレイする方は<b>迷惑行為</b>、<b>禁止事項</b>が分からない部分もあると思います。\r\nまず、<b>初心者ガイド</b>や<b>用語説明</b>などを参考にしつつ<color=blue>霊能者COしているプレイヤーの発言を中心に</color><b>観戦</b>してみるとよいでしょう。";
                        //観戦画面への誘導画像
                        break;
                }
                break;
